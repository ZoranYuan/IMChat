...
type FriendRequestRepository interface {
	FindLatestRequest(applicantUserId string, targetUserId string) (*friendentity.FriendRequest, error)
	...
	ListByUserID(targetUserId string) ([]*friendentity.FriendRequest, error)

...
const file_ws_proto_rawDesc = "" +
	...
	"\x06avatar\x18\x06 \x01(\tR\x06avatar\"\xc3\x04\n" +
	...
	"\rclient_msg_id\x18\v \x01(\tR\vclientMsgId\x12\x14\n" +
	...
	"\n" +
	"video_time\x18\x18 \x01(\x03R\tvideoTime\x12#\n" +
	"\rattachment_id\x18\x19 \x01(\tR\fattachmentIdB*Z(IM_backend/internal/transport/ws/pb;wspbb\x06proto3"

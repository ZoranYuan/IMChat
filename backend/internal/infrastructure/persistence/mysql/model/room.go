...
type Room struct {
	...
	OwnerUserId string `json:"ownerUserId" gorm:"size:32;idx_owner_id_room_name;priority:1;not null"`
	Description string `json:"description" gorm:"comment:群介绍"`
	RoomName    string `json:"roomName" gorm:"size:10;index;idx_owner_id_room_name;priority:2;comment:群昵称"`
